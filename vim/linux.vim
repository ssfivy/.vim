...
if has("cscope")
    ...
    "
    " Note for vim 7, CTRL-spacebar is configured as <C-@>
    " but on neovim CTRL-spacebar is configured as <C-Space>
    " Not sure what vim 8 uses.
    " See https://github.com/neovim/neovim/issues/5960
